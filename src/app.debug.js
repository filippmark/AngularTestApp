                    ...
                    angular.module('app')._invokeQueue.forEach(item => {
                        if (item[1] == 'component') {
                            ...
                            if (componentProperties.templateUrl) {
                                ...
                                template = `<div class="debugging-border">Component: <b>${componentName}</b><div ng-include="\'${templateUrl}\'"></div></div>`;
                            } else {
                                template = `<div class="debugging-border">${componentName}<div>${componentProperties.template}</div></div>`;
                            }
